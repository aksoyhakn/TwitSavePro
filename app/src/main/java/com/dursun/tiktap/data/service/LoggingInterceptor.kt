...
class LoggingInterceptor @Inject constructor(var preferenceHelperImp: PreferenceHelperImp) :
    ...
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        preferenceHelperImp.getQuestToken()?.takeIf { it.isNotEmpty() }?.apply {
            requestBuilder.addHeader("X-Guest-Token", this)
        }
        ...
        try {
            ...
            request.url.toString().takeIf { it.contains("v16-webapp") }?.apply {
                ...
                val jsonString = "{\"guest_token\":\"data:video/mp4;base64,${encode}\"}"

...
fun String.phoneNumberRegex():String = this.replace("[^0-9]".toRegex(), "")

fun String.convertNumberRegex():String = this.replace("[^0-9]".toRegex(), "")

fun String.emailRegex():Boolean = "^[A-Za-z](.*)([@]{1})(.{1,})(\\.)(.{1,})".toRegex().matches(this);
